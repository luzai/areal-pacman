...
python scripts/prepare_level1_dataset.py --write-hf
python train_areal.py --config configs/level1_image_overfit_2epoch.yaml --dry-run
cp configs/level1_image_overfit_2epoch.yaml "${ARTIFACT_ROOT}/config.resolved.yaml"
python scripts/write_level1_manifest.py \
...
python train_areal.py --config configs/level1_image_overfit_2epoch.yaml \
...
python scripts/build_complete_vlm_checkpoint.py \
