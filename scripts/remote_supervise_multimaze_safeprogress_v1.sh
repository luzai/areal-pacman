...
TRAIN_CONFIG=config_vision_rollout_qwen3p5_9b_imageonly_multimaze_v1_safeprogress_grpo_3epoch_4sample_8gpu.yaml
EVAL_CONFIG=config_vision_rollout_qwen3p5_9b_imageonly_multimaze_v1_notrain_4sample_8gpu.yaml
...
summarize_split() {
    ...
    local split=$2
    local output=$3
    "$PYTHON" scripts/summarize_multi_maze_rollouts.py \
...
"$PYTHON" scripts/build_multi_maze_comparison.py \
