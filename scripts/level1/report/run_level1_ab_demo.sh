...
PYTHON="${PYTHON:-/mnt/data/z00819216/conda_env/maapacman-rl/bin/python}"
PACMAN_PYTHON_ROOT="${PACMAN_PYTHON_ROOT:-/mnt/data/z00819216/maapacman-stack/pacman-python}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${SOURCE_RUN}/ab_demo_latest}"
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-${SOURCE_RUN}/training/checkpoints/ubuntu/maapacman-level1/overfit-openmask200-step32-r14-20260728T224000Z/default}"
GPU_ID="${GPU_ID:-0}"
PORT="${PORT:-18269}"
SEED="${SEED:-0}"
